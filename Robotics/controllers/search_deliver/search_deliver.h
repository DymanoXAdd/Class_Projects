...
#ifndef SEARCH_DELIVER_H
#define SEARCH_DELIVER_H
 ...
 */
class CFootBotSearchDeliver : public CCI_Controller {
...
public:
    ...
    * <controllers><search_deliver_controller><parameters><diffusion>
    * section.
    */
    ...
    * file, under the
    * <controllers><search_deliver_controller><parameters><wheel_turning>
    * section.
    */
...
public:
   ...
   /* Class constructor. */
   CFootBotSearchDeliver();
   /* Class destructor. */
   virtual ~CFootBotSearchDeliver() {}

   /*
    * This function initializes the controller.
    * The 't_node' variable points to the <parameters> section in the XML
    * file in the <controllers><search_deliver_controller> section.
    */
